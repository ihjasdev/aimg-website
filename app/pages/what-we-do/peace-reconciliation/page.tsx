        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 lg:py-28">
          <div className="text-center">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-600 max-w-2xl mx-auto">
              In post-war Sri Lanka, reconciliation and peacebuilding are
              crucial for national healing. At AIMG, we champion initiatives
              that promote social cohesion and inter-community harmony among
              ...
              <div className="lg:pr-4">
                <div className="lg:max-w-lg" data-aos="zoom-in-right">
                  ...
                  <p className="mt-6 text-gray-700 mb-6">
                    We support efforts to address historic injustices through
                    memorialization, torture survivor support, and recognition
                    of victims of conflict-related abuses, including sexual
                    violence. Our work encourages open dialogue and inclusive
                    remembrance to foster healing.
                  </p>
                  ...
                  <p className="mt-6 text-gray-700 mb-6">
                    Through our Interfaith Dialogue Circle, we bring together
                    different faith communities to build mutual respect and
                    trust. AIMG facilitates community exchanges to promote
                    pluralism, protect religious freedom, and strengthen
                    language rights among all communities.
                  </p>
                  <h1 className="mt-2 text-base/7 font-semibold tracking-tight text-pretty text-gray-900 sm:text-2xl">
                  Community Empowerment and Participation
                  </h1>
                  <p className="mt-6 text-gray-700">
                    We actively engage women and vulnerable groups in the
                    peacebuilding process, ensuring their voices influence
                    national and international mechanisms. By raising awareness
                    and tracking peace initiatives, AIMG empowers communities to
                    demand inclusion and sustainable peace.
                  </p>
                </div>
              </div>
            </div>
